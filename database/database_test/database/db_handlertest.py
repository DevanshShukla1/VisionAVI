...
class SceneDatabase:
    def __init__(self, db_path: str = 'scenes.db'):
        ...
        self._create_tables()  # This is called here
        
    # PROPERLY INDENTED METHOD
    def _create_tables(self):
        """Initialize database schema"""
        with open(r'D:\Devansh\Computer vision course\Main_project\Database_design\Database_design\database_test\database\schematest.sql', 'r') as f:
            schema_sql = f.read()
        with self.conn:
            self.conn.executescript(schema_sql)

    # REST OF YOUR METHODS FOLLOW (keep existing indentation)
